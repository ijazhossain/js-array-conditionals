...
var requiredNumber = 86;
if (requiredNumber < 50) {
    console.log('You get grade F');
} else if (requiredNumber >= 50 && requiredNumber <= 60) {
    console.log('You get grade D');
} else if (requiredNumber >= 60 && requiredNumber <= 70) {
    console.log('You get grade C');
} else if (requiredNumber >= 70 && requiredNumber <= 80) {
    console.log('You get grade B');
} else if (requiredNumber >= 80 && requiredNumber <= 90) {
